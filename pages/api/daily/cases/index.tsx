...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    const response1 = await fetch('https://raw.githubusercontent.com/ysjprojects/covid19-json-data/main/daily_cases.json')
    ...
    const response2 = await fetch("https://raw.githubusercontent.com/ysjprojects/covid19-json-data/main/daily_cases_updated_at.json")
